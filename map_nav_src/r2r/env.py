...
class EnvBatch(object):
    ...
    def getStates(self):
        ...
        for i, sim in enumerate(self.sims):
            ...
            feature = self.feat_db.get_image_feature(state.scanId, state.location.viewpointId, type=self.args.img_type)
...
class R2RNavBatch(object):
    ...
    def __init__(
        ...
        speaker_angle_feat_size=128,tok=None,args=None
    ):
        self.args = args
        ...
        # For speaker.
        if args.use_speaker or 'speaker' in self.args.train:
            ...
            for item in self.data:
                self.gt_insts[item['path_id']].append(item['instruction'])
            ...
            for ix in range(36):
                ...
                for j, loc in enumerate(state.navigableLocations[1:]):
                    ...
                    if (loc.viewpointId not in adj_dict or
                        ...
                        if self.args.use_speaker or 'speaker' in self.args.train:
    ...
    def _teacher_path_action(self, state, path, t=None):
        teacher_vp = None
        if t is not None:
    ...
    def _get_obs(self):
        ...
        for i, (feature, state) in enumerate(self.env.getStates()):
            ...
            if self.args.use_speaker or 'speaker' in self.args.train:
                ...
                if 'speaker' in self.args.train:
                    ob['speaker_progress'] = item['speaker_progress']
                    ob['sub_chunk_view'] = item['sub_chunk_view']
                    ob['sub_instr'] = item['sub_instr']
