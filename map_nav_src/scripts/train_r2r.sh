...
speaker_path=${DATA_ROOT}/R2R/speaker/speaker_vit/ckpts/best_unseen_bleu
aug_path=${DATA_ROOT}/R2R/annotations/prevalent_aug_train_enc.json
resume_file=${DATA_ROOT}/R2R/follower/vit/model_step_340000.pt
